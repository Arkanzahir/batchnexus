...
export const theme = createTheme({
  colors: {
    primary: [
      "var(--ds-primary-100, #eff7f3)",
      "var(--ds-primary-200, #dbebe3)",
      "var(--ds-primary-300, #b4d5c4)",
      "var(--ds-primary-400, #8abb9e)",
      "var(--ds-primary-500, #64a37e)",
      "var(--ds-primary-600, #498e65)",
      "var(--ds-primary-700, #387150)",
      "var(--ds-primary, #2F6B4F)",
      "var(--ds-primary-800, #275640)",
      "var(--ds-primary-900, #204736)"
    ],
    accent: [
